...
const photoOne = document.getElementById(photo-1);
const photoTwo = document.getElementById(photo-2);
const photoThree = document.getElementById(photo-3);

// on load
  const firstArrayFunction = (products) => {
  ...
  let priorSet = firstArray;
  return priorSet;
}

// state engaged

/* NOOOOO export const getValidProducts = (products, priorSet) => {
